    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed  top-2/4 left-2/4 max-h-[85vh] max-h w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-md bg-gray-800 p-6 focus:outline-none">
          ...
          >
            Edite o nome e a categoria da sua tarefa abaixo e clique em {" '"}
            Salvar{"' "}
            para atualizá-la. Certifique-se de escolher um nome que ainda
            descreva claramente a tarefa. Lembre-se de que você pode editar ou
            excluir a tarefa a qualquer momento.Boa sorte!
          </Dialog.Description>
